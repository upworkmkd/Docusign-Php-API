...
class ApiClient
{
    ...
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null)
    {
		...
		$htpbody_array=json_decode($http_body);
		if(isset($htpbody_array->errorCode))
		{
			$errorcode=$htpbody_array->errorCode;
			$errormessage=$htpbody_array->message;
		}
        ...
        if ($response_info['http_code'] == 0) {
			echo builderUX_flash('danger',"API call to $url timed out. Error Code: <b>$errorcode</b>. Error Message : $errormessage",'','');
			...
			//echo builderUX_flash('danger',"Error connecting to the API. Error Code: <b>$errorcode</b>. Error Message : <b>$errormessage</b>",'','');
			//return array('error'=>$errormessage,'errorno'=>$errorcode);
